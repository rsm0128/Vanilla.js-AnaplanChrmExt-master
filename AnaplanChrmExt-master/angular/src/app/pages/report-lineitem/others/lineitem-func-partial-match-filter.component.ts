...
export class LineItemFuncPartialMatchFilter implements IFilterAngularComp {
  ...
  funcSearchFilter(funcName: string): void {
    console.log(funcName);
    this.onChange(funcName);
  }

  listSearchFilter(funcName: string): void {
    console.log(funcName);
    this.onChange(funcName);
  }
